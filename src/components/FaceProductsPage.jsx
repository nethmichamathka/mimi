...
const FaceProductsPage = () => {
  const products = [
    { name: "Foundation", price: "$30.00", img: foundation },
    { name: "Concealer", price: "$25.00", img: concealer },
    { name: "Blush", price: "$20.00", img: blush },
    { name: "Face Primer", price: "$18.00", img: facePrimer },
    { name: "Highlighter", price: "$22.00", img: highlighter },
    { name: "Setting Powder", price: "$15.00", img: settingPowder },
  ];
